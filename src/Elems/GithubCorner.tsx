...
export default class GithubCorner extends React.Component {
   render() {
      ...
      return (
         <ExternalLink href="https://github.com/icecream17/solver" className="github-corner" aria-label="View source on GitHub (opens in new tab)">
            <svg width="80" height="80" viewBox="0 0 250 250" role="img">
               <title>View source on GitHub (opens in new tab)</title>
               <desc>GitHub&apos;s logo, the Octocat. The code uses the animation &quot;octocat-wave&quot; when the mouse hovers over it.</desc>
